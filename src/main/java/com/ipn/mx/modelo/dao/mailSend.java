    ...
    public static void sendAsHtml(String to, String title, int tipo) throws MessagingException {
        ...
        if (tipo == 0) {
            ...
            prepareEmailMessage(message, to, title,
                    ...
                    + "  <p class=\"lead\"><strong>Te agradecemos tu registro en nuestra pagina de productos ESCOM</p>\n"
                    + "  <p>\n"
                    + "    Tu cuenta fue registrada con el correo: " + to + "\n"
                    + "  </p>\n"
                    + "  <hr>\n"
                    + "  <p>\n"
                    + "    Esta pagina fue desarrollada por: Gerardo Gonzalez Garzon <a href=\"mailto:ggonzalezg1300@alumno.ipn.mx\">Contacto</a>\n"
                    + "  </p>\n"
                    + "  <br />\n"
                    + "  <p class=\"lead\">\n"
